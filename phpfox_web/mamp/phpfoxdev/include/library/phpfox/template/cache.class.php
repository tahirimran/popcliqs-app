 ...
 * @package 		Phpfox
 * @subpackage 		Template
 * @version 		$Id: cache.class.php 5491 2013-03-12 08:12:07Z Miguel_Espinoza $
 */
	...
	private function _parseFunction($sFunction, $sModifiers, $sArguments)
	{
		switch ($sFunction)
		{
			...
			case 'select_gender':
				...
				$sGenders = '<input type="radio" name="val[gender]" id="gender" value="1">&nbsp;Male &nbsp;';
				$sGenders .= '<input type="radio" name="val[gender]" id="gender" value="2">&nbsp;Female';
