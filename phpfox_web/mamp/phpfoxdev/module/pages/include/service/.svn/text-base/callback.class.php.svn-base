 ...
 * @version 		$Id: callback.class.php 5455 2013-02-28 14:17:39Z Miguel_Espinoza $
 */
class Pages_Service_Callback extends Phpfox_Service 
{
	...
	{		
		...
		if (!PHPFOX_IS_AJAX && $aRow['reg_method'] == 2 && ( (Phpfox::getLib('request')->get('req1') != 'pages') && (Phpfox::getLib('request')->get('req1') != $aRow['vanity_url'])))
		{
			return false;
		}
