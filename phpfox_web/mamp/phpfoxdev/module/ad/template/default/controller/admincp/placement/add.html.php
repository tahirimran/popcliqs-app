	...
	<div class="table">
		...
		<div class="table_right">
			<select name="val[is_cpm]" id="is_cpm">
				...
				<option value="1"{value type='select' id='is_cpm' default='1'}>CPM (Cost per mille)</option>
				<option value="0"{value type='select' id='is_cpm' default='0'}>PPC (Pay per click)</option>
			</select>			
		</div>
	</div>
