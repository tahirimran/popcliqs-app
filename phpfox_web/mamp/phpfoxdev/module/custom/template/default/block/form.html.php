...
?>
		<div class="custom_block_form">
			...
			{elseif $aSetting.var_type == 'text'}
				<input type="text" name="custom[{$aSetting.field_id}]" value="{if isset($aSetting.value)}{$aSetting.value|clean}{/if}" size="30" maxlength="255"  style="width:100px"{if PHPFOX_IS_AJAX} style="width:90%;"{/if} />
