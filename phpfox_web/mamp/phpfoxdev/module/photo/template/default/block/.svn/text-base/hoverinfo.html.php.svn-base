...
{if Phpfox::getParam('photo.show_info_on_mouseover')}
	...
	<div class="photo_hover_info_actions">
		...
		<div class="photo_hover_info_actions_do">
		    ...
		    <a href="#" class="js_dislike_photo js_toggle_dislike_{$aPhoto.photo_id}" id="js_dislike_photo_{$aPhoto.photo_id}" {if isset($aPhoto.is_disliked) && $aPhoto.is_disliked}style="display:none;"{/if} onclick="$Core.Photo.inlineAction({$aPhoto.photo_id}, 'js_dislike', 'doAction', 'js_toggle_dislike_{$aPhoto.photo_id}');return false;">{phrase var='like.dislike'}</a>
		    <a href="#" class="js_undislike_photo js_toggle_dislike_{$aPhoto.photo_id}" id="js_undislike_{$aPhoto.photo_id}" {if isset($aPhoto.is_disliked) && !$aPhoto.is_disliked}style="display:none;"{/if} onclick="$Core.Photo.inlineAction({$aPhoto.photo_id}, 'js_dislike', 'removeAction', 'js_toggle_dislike_{$aPhoto.photo_id}');return false;">{phrase var='like.undislike'}</a>
		    {/if *}
		</div>
