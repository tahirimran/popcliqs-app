		...
		<div class="video_width_holder">
			<div class="video_height_holder">
				...
				{/if}					
					...
					<a href="{$aVideo.link}" class="js_video_title_{$aVideo.video_id}">
						...
						{else}
							{img server_id=$aVideo.image_server_id path='video.url_image' file=$aVideo.image_path suffix='_120' max_width=120 max_height=90 class='js_mp_fix_width video_image_border' title=$aVideo.title}
						{/if}
					</a>				
				</div>
			</div>			
			...
			<div class="extra_info_link">
				...
				{if !defined('PHPFOX_IS_USER_PROFILEs')}			
					{phrase var='video.by_full_name' full_name=$aVideo|user:'':'':20}			
				{/if}
