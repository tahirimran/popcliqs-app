...
<?php /* Cached: August 24, 2013, 9:05 pm */ ?>
<?php 
/**
 * [PHPFOX_HEADER]
 * 
...
<?php if (Phpfox ::getParam('user.reenter_email_on_signup')): ?>
		<div class="table">
			<div class="table_left" style="padding-top:10px;">
				<label for="confirm_email" ><?php if (Phpfox::getParam('core.display_required')): ?><span class="required"><?php echo Phpfox::getParam('core.required_symbol'); ?></span><?php endif;  echo Phpfox::getPhrase('user.please_reenter_your_email_again_below'); ?>:</label>
			</div>
			<div class="table_right">
...
<?php if (Phpfox ::getParam('core.registration_enable_gender')): ?>
		<div class="table">
			...
			<div class="table_right">
				<input type="radio" name="val[gender]" id="gender" value="1">&nbsp;Male &nbsp;<input type="radio" name="val[gender]" id="gender" value="2">&nbsp;Female
			</div>			
		</div>
<?php endif; ?>
<?php if (! isset ( $this->_aVars['bIsPosted'] ) && Phpfox ::getParam('user.multi_step_registration_form')): ?>
...
<?php elseif ($this->_aVars['aSetting']['var_type'] == 'text'): ?>
				<input type="text" name="custom[<?php echo $this->_aVars['aSetting']['field_id']; ?>]" value="<?php if (isset ( $this->_aVars['aSetting']['value'] )):  echo Phpfox::getLib('phpfox.parse.output')->clean($this->_aVars['aSetting']['value']);  endif; ?>" size="30" maxlength="255"  style="width:100px"<?php if (PHPFOX_IS_AJAX): ?> style="width:90%;"<?php endif; ?> />
...
<?php endif; ?>
					<div class="table_clear">
<?php echo Phpfox::getPhrase('user.i_have_read_and_agree_to_the_a_href_id_js_terms_of_use_terms_of_use_a_and_a_href_id_js_privacy_policy_privacy_policy_a'); ?>
					</div>
...
<?php endif; ?>
					...
					<div class="table_clear">
<?php if (isset ( $this->_aVars['bIsPosted'] ) || ! Phpfox ::getParam('user.multi_step_registration_form')): ?>
						<input type="submit" value="" class="button_register" id="js_registration_submit" />
<?php else: ?>
